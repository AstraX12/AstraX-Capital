                ...
                <div className="hidden below-1024:hidden md:block">
                  ...
                  <div className="relative bg-white rounded-lg p-4 m-2 shadow-lg" style={{ height: '570px', width: '340px' }}>
                    ...
                    <div className="relative bg-white rounded-lg p-4 m-2 shadow-lg" style={{ height: '570px', width: '340px' }}>
                      ...
                      <h1 className="pb-0 text-center md:text-xl text-2xl font-bold text-gray-700">Atty. Rafael Padilla</h1>
                      <h2 className="sm:pb-1 pb-2 text-center md:text-lg text-xl font-medium text-gray-600">Legal Counsel</h2>
                      <p className="sm:mb-14 mb-0 text-center md:text-sm text-based leading-none font-medium text-gray-800">
                        Atty. Rafael Padilla is a commercial attorney specializing in financial technology, cryptoassets, and blockchain, providing legal and compliance services to numerous blockchain projects and fintech startups in the Philippines. 
                        He serves as a special consultant for the Aurora Pacific Economic Zone Authority (APECO) on financial technology and digital assets. An adjunct Professor of Law at San Beda Alabang School of Law, 
                        he teaches Statutory Construction, Constitutional Law, and Tax. Atty. Padilla co-founded the Blockchain Association of the Philippines 
                        and the Fintech Philippines Association, and recently co-founded Block Devs Asia, Inc., a professional association of blockchain developers.
                      </p>
                    </div>
                    </div>
                    </div>
            ...
            <div className="below-1024:block below-540:hidden lg:hidden">
              <div className="flex justify-center items-center">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-1">
                  ...
                  <div className="flex justify-center items-center pt-2">
                  <div className="flex justify-between">
                  <div className="relative bg-transparent rounded-lg p-4 m-2">
                    <div className="relative flex justify-center items-center z-15 px-20">
                    </div>
                  </div>
                    <div className="relative bg-white rounded-lg p-4 m-2">
                    <div className="relative flex justify-center items-center z-15">
                      <Image
                        src="/team/atty padilla.png"
                        alt="karan"
                        width={150}
                        height={140}
                      />
                    </div>
                    <h1 className="pb-0 text-center text-lg md:text-xl font-bold text-gray-700">Atty. Rafael Padilla</h1>
                    <h2 className="pb-1 text-center text-sm md:text-lg font-medium text-gray-600">Legal Counsel</h2>
                    <p className="mb-0 mx-6 text-center leading-none text-xs md:text-sm font-medium text-gray-700">
                    Atty. Rafael Padilla is a commercial attorney specializing in financial technology, cryptoassets, and blockchain, providing legal and compliance services to numerous blockchain projects and fintech startups in the Philippines. 
                        He serves as a special consultant for the Aurora Pacific Economic Zone Authority (APECO) on financial technology and digital assets. An adjunct Professor of Law at San Beda Alabang School of Law, 
                        he teaches Statutory Construction, Constitutional Law, and Tax. Atty. Padilla co-founded the Blockchain Association of the Philippines 

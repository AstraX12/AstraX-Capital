...
const Team = () => {
  return (
    ...
    >
              <div className="flex pl-16 pr-18 py-24 items-center text-center flex-col md:flex-row">
                <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
                  
                  <h1 className="title-font sm:text-4xl text-4xl font-large text-pink-800 text-shadow font-bold">
                  MEET THE TEAM
                  </h1>
                </div>
              </div>
                ...
                <div className="py-0 px-0 md:px-32">
                    <div className="flex flex-wrap justify-center mt-4">
                      <div className="m-2 w-full md:w-1/2 lg:w-1/4 flex-shrink-0  flex justify-center items-center relative">
                        ...
                        <div className="absolute bottom-0 left-0 right-0 p-4 md:p-10 text-gray-700">

...
const Team = () => {
  return (
    ...
    >
              <div className="flex sm:pl-0 pl-0 sm:pr-0 pr-0 sm:pt-20 pt-16 sm:pb-4 pb-0 items-center text-center flex-col md:flex-row">
                ...
                <div className="py-0 px-0 md:px-32">
                    <div className="flex flex-wrap justify-center mt-4">
                      <div className="m-2 w-full md:w-1/2 lg:w-80 flex-shrink-0  flex justify-center items-center relative">
                        ...
                        <div className="absolute bottom-0 left-0 right-0 md:p-10 p-10 text-gray-600">
                          <h1 className="pb-1 text-center md:text-lg text-xl font-bold text-gray-700" >Andy Agnas</h1>
                          <h2 className="pb-2 text-center md:text-sm text-lg font-medium text-gray-600" >Founding Partner & CEO</h2>
                          <p className="mb-3 text-center md:text-xs text-sm font-medium">Andy is a Certified Public Accountant (CPA) by profession 
                      ...
                      <div className="m-2 w-full md:w-1/2 lg:w-80 flex-shrink-0  flex justify-center items-center  relative">
                        ...
                        <div className="absolute bottom-0 left-0 right-0 md:p-14 p-14 text-gray-600">
                          <h1 className="pb-1 text-center md:text-lg text-xl font-bold text-gray-700" >Rico Zuñiga</h1>
                          <h2 className="pb-2 text-center md:text-sm text-lg font-medium text-gray-600" >Venture Associate</h2>
                          <p className="mb-3 text-center md:text-xs text-sm font-medium">Rico is a serial tech entrepreneur and early advisor 
                      ...
                      <div className="m-2 w-full md:w-1/2 lg:w-80 flex-shrink-0 flex justify-center items-center relative">
                        ...
                        <div className="absolute bottom-0 left-0 right-0 md:p-16 p-16 text-gray-600">
                          <h1 className="pb-1 text-center md:text-lg text-xl  font-bold text-gray-700" >Karan Sharma</h1>
                          <h2 className="pb-2 text-center md:text-sm text-lg font-medium text-gray-600" >Venture Analyst</h2>
                          <p className="mb-3 text-center md:text-xs text-sm font-medium">Karan is an experienced advisor and investor in the 
